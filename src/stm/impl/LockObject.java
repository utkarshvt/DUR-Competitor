...
public class LockObject
{
	...
	public void unlock(String Id)
	{
		if(lock.isLocked())
		{
			System.out.println("Called unlock on locked object " + Id);
			lock.unlock();
			System.out.println("Unlocked on locked object " + Id);
		}	
		else
		{
			System.out.println("Called unlock on unlocked object " + Id);
		}
	}
}
